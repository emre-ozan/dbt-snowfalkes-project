  ...
  create or replace   view PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.model_run_results
...
dbt_models as (
    select * from PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.dbt_models
)
