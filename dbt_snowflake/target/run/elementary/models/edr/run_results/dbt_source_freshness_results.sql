-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.dbt_source_freshness_results as DBT_INTERNAL_DEST
        using PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.dbt_source_freshness_results__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
    ...
    when not matched then insert
        ("SOURCE_FRESHNESS_EXECUTION_ID", "UNIQUE_ID", "MAX_LOADED_AT", "SNAPSHOTTED_AT", "GENERATED_AT", "CREATED_AT", "MAX_LOADED_AT_TIME_AGO_IN_S", "STATUS", "ERROR", "COMPILE_STARTED_AT", "COMPILE_COMPLETED_AT", "EXECUTE_STARTED_AT", "EXECUTE_COMPLETED_AT", "INVOCATION_ID")
    values
        ("SOURCE_FRESHNESS_EXECUTION_ID", "UNIQUE_ID", "MAX_LOADED_AT", "SNAPSHOTTED_AT", "GENERATED_AT", "CREATED_AT", "MAX_LOADED_AT_TIME_AGO_IN_S", "STATUS", "ERROR", "COMPILE_STARTED_AT", "COMPILE_COMPLETED_AT", "EXECUTE_STARTED_AT", "EXECUTE_COMPLETED_AT", "INVOCATION_ID")
