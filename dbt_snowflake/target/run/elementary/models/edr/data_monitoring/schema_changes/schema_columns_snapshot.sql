-- back compat for old kwarg name
  ...
  begin;
    ...
    merge into PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.schema_columns_snapshot as DBT_INTERNAL_DEST
        using PREDICTIVE_MAINTENANCE.DBT_WITH_SNOWFLAKE_elementary.schema_columns_snapshot__dbt_tmp as DBT_INTERNAL_SOURCE
        on (
